    ...
    <>
      ...
      <div className={mStyle.bodyClass + ' d-flex'}>
        ...
        <div className="container d-flex flex-column  align-items-center pt-5">
          ...
          <div className={mStyle.product_card + ' container d-flex flex-column pb-5 align-items-center pt-5'}>
          <div className={fpStyle.page_check}>
            ...
            <div className="d-flex flex-wrap">
              ...
              <div className={fpStyle.card + ' m-4 rounded-4'}>
                ...
                <div className="card-body p-3 pt-0">
                  ...
                  <h5 className="card-text mt-2 mb-1 text-black fw-bold">舞力全開！</h5>
