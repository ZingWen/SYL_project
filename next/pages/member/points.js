  ...
  return (
    <>
      ...
      <div className={mStyle.bodyClass + ' d-flex'}>
        <SideBar />
        <div className={pStyle.point_frame+" container d-flex flex-column justify-content-center align-items-center"}>
          ...
          <div className={pStyle.level_div +" d-flex py-4 justify-content-center align-items-center"}>
            <div className={pStyle.margin_auto}>
              <div className={pStyle.level_frame}>
                <Image className={pStyle.img_fit} src={cracked} alt="cracked" />
              </div>
              <div className={pStyle.line}></div>
              <div className={pStyle.level_frame}>
                <Image className={pStyle.img_fit} src={brutal} alt="cracked" />
              </div>
              <div className={pStyle.line}></div>
              <div className={pStyle.level_frame}>
                <Image className={pStyle.img_fit} src={warlord} alt="cracked" />
              </div>
              <div className={pStyle.line}></div>
              <div className={pStyle.level_frame}>
            ...
            <div className={pStyle.column_leveltext}>
              <div className={pStyle.border_bm + '  pb-3'}>
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <h6 className={pStyle.blue_text}>積分 &lt;&nbsp;&nbsp; 5000</h6>
                </div>
              ...
              <div className={pStyle.border_bm + '  pb-3'}>
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <h6 className={pStyle.second_text}>積分 &lt;&nbsp;&nbsp; 9000</h6>
                </div>
                <h5 className={pStyle.white_text}>
